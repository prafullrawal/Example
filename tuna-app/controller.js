...
return{
	...
	add_record: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // addRecord - requires 5 args, ID, vessel, location, timestamp,holder - ex: args: ['10', 'Hound', '-12.021, 28.012', '1504054225', 'Hansel'], 
		    // send proposal to endorser
		    const request = {
		        //targets : --- letting this default to the peers assigned to the channel
		        chaincodeId: 'mycc',
		        fcn: 'addRecord',
		        args: [key, vessel, Rstatus, timestamp, holder ,deviceId ,Pstatus],
		        chainId: 'mychannel',
		        txId: tx_id
			};
...
//		        res.send(tx_id.getTransactionID());
	...
	receive_item: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
			...
			// Disconnecting IOT Client
			IOTStatus.disconnectIOT(req,res);
